# 🔌 INTEGRATION GUIDE - Jak zintegrować nowe funkcje

Ten dokument pokazuje **krok po kroku** jak dodać wszystkie nowe funkcje do istniejącego kodu `bakery-planning-slovenian_1.jsx`.

---

## 📋 **KROK 1: Importy**

Na początku pliku `BakeryPlanningSystem.jsx`, dodaj importy:
...
## 📋 **KROK 2: Nowe State Variables**

W komponencie, dodaj nowe stany:
